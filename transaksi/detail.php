    ...
    <div class="col-md-7">
      ...
      <tr>
        <td class="text-right" colspan="2">
          ...
          <a class="btn btn-secondary <?php if($detail['tgl_kembali'] != NULL) { echo "disabled"; } ?>" href="form-kembali.php?id_pinjam=<?= $detail['id_pinjam'] ?>&id_buku=<?= $detail['id_buku'] ?>" role="button">
            Form Pengembalian
          </a>
        </td>
      </tr>
